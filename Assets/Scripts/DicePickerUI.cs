...
/// <summary>
/// Zar kozmetik seçim modal?n? yönetir.
/// `LobbyUINew` ve `DiceSlotUI` ile birlikte çal???r.
/// </summary>
public class DicePickerUI : MonoBehaviour
{
    ...
    // Callback: seçim yap?l?nca ça?r?l?r
    ...
    /// <summary>
    /// Verilen indeks için zar skin bilgisini döner.
    /// </summary>
